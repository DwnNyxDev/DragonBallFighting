function scr_downPunchGoku11() {
	if(sprite_index!=spr_downPunchGoku1){
		sprite_index=spr_downPunchGoku1;
		image_index=0;
		attacking=true;
	...
	if(image_index>3&&image_index<4&&hitbox=-1){
		hitbox=hitbox_create(image_xscale,1,0*image_xscale,0,6*(1/global.RelativeSpeed),1*image_xscale,20,25,5,8);
