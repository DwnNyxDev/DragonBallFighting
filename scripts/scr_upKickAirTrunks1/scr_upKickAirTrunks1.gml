function scr_upKickAirTrunks1() {
	if(sprite_index!=spr_upKickAirTrunks1){
		sprite_index=spr_upKickAirTrunks1;
		image_index=0;
		attacking=true;
	...
	if(image_index>1&&image_index<2&&hitbox=-1){
		hitbox=hitbox_create(image_xscale,1,0*image_xscale,0,6*(1/global.RelativeSpeed),3*image_xscale,-4,35,10,7);
		hitbox.sprite_index=spr_upKickAirTrunks_hitbox;
	}
