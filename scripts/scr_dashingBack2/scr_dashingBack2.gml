function scr_dashingBack2() {
	...
	*/
	...
	if(flying||jumping){
		if(sprite_index!=spr_dashingBackFlyingGoku){
			sprite_index=spr_dashingBackFlyingGoku;
			image_index=0;
			frames=20;
		...
		if(sprite_index!=spr_dashingBackGoku){
