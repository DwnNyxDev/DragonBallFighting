function scr_crouchingPunchGoku11() {
	if(sprite_index!=spr_crouchPunchGoku1){
		sprite_index=spr_crouchPunchGoku1;
		image_index=0;
		attacking=true;
	...
	if(image_index>1&&image_index<2&&hitbox=-1){
		hitbox=hitbox_create(image_xscale,1,0*image_xscale,0,10*(1/global.RelativeSpeed),4*image_xscale,0,15,3,3);
		hitbox.sprite_index=spr_crouchPunch_hitbox;
	}
