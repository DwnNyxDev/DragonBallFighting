function scr_downPunchTrunks1() {
	if(sprite_index!=spr_downPunchTrunks1){
		sprite_index=spr_downPunchTrunks1;
		image_index=0;
		attacking=true;
	...
	if(image_index>2&&image_index<3&&hitbox=-1){
		hitbox=hitbox_create(image_xscale,1,0*image_xscale,0,6*(1/global.RelativeSpeed),0*image_xscale,12,40,5,8);
		hitbox.sprite_index=spr_downPunchTrunks_hitbox;
