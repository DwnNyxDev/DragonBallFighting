function scr_downKickGoku11() {
	if(sprite_index!=spr_downKickGoku1){
		sprite_index=spr_downKickGoku1;
		image_index=0;
		attacking=true;
	...
	if(image_index>3&&image_index<4&&hitbox=-1){
		hitbox=hitbox_create(image_xscale,1,0*image_xscale,0,6*(1/global.RelativeSpeed),3*image_xscale,20,32,5,10);
		hitbox.sprite_index=spr_downKick_hitbox;
